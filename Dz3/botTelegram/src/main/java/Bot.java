...
import static utils.PhotoMessageUtils.processingImage;
...
public class Bot extends TelegramLongPollingBot {
    ...
    private Object runPhotoFilter(Message newMessage) {
        ...
        if (photoMessage != null) {
            List<org.telegram.telegrambots.meta.api.objects.File> files =
                    getFilesByMessage(photoMessage);
            try {
    ...
    public String getBotToken(){
        return "6010391452:AAHa_YOWn2LX1zEIs1eg__km3i84dNaKENI";
    }

    @Override
    public String getBotUsername() {
        return "Super_227_bot";
    }
}
